...
{
    public static function mdlGuardarTokenCorreo($email, $token, $expira)
    {
        try {
            $stmt = Conexion::conectar()->prepare("
            UPDATE usuarios 
            SET token_correo = :token, token_correo_expira = :expira
            WHERE email = :email
        ");
    ...
    public static function mdlActualizarContrasenaPorCorreo($email, $nuevaContrasena)
    {
        try {
            $stmt = Conexion::conectar()->prepare("
            UPDATE usuarios 
