            ...
            <tbody>
                <?php foreach ($detalleItems as $item): ?>
                    <?php
                        ...
                        $precioUnitario = $item['cantidad'] > 0 ? $item['costoSubTotal'] / $item['cantidad'] : 0;
                    ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="index.php?controlador=carrito&accion=eliminarItem" onsubmit="return confirm('¿Eliminar este ítem?');" style="display:inline-block;">
